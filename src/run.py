...
if args.function == 'pretrain':
    ...
    tconf = trainer.TrainerConfig(max_epochs=650,batch_size=128,learning_rate=6e-3,lr_decay=True,warmup_token=512 * 20,final_tokens=200 * len(pretrain_dataset) * block_size,num_workers=4)
    ...
    lines_birth = open(args.finetune_corpus_path, 'r').read()
    train_dataset = dataset.NameDataset(pretrain_dataset, lines_birth)
