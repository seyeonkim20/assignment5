...
class CharCorruptionDataset(Dataset):
    ...
    def __getitem__(self, idx):
        ...
        assert truncate_len >= 4, (len_doc, truncate_len, masked_len, document, idx)
        idx_full = random.randint(1, truncate_len - masked_len - 1)
        
        prefix = truncated_document[:idx_full]
        masked_content = truncated_document[idx_full : idx_full + masked_len]
        suffix = truncated_document[idx_full + masked_len:]
